            ...
            if (result >= 0)
            {
                ...
                if (result >= 0)
                {
                    ...
                    if (result == 0)
                    {
                        ...
                        if (result == 0)
                        { // DVD Player update of the right region exists and is newer.
...
static int DVDPlayerGetUpdateVersion(const char *file, int *pPort, int *pSlot)
{
    ...
    if ((result = DVDPlayerUpdateCheck(pPort, pSlot, NULL)) == 0)
    { // DVD Player update of the right region exists and is newer.
...
const char *DVDPlayerGetVersion(void)
{
    ...
    if (DVDPlayerUpdateCheck(NULL, NULL, DVDPlayerUpdateVer) == 0)
    { // DVD Player update of the right region exists and is newer.
